...
> Spec for `banner.png` (repo header image). The current `banner.png` was generated 2026-05-11, **before** the v0.1.0 durable-provider reframe — verify it against this brief before launch, regenerate if it leads with Fitbit.
